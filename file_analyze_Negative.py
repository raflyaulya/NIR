...
def airline_func_Negative(airline_name):
...
# print('Please select which sentiment reviews you want to analyze')
    ...
    sentiment_reviews = df[df['sentiment'] == negative_review]
    ...
    most_common_words = freq_dist.most_common(30)  #show
